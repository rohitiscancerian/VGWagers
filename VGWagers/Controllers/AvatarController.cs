...
namespace AvatarUploadMvc5.Controllers
{
    public class AvatarController : Controller
    {
        ...
        private const int AvatarScreenWidth = 272;  // ToDo - Change the value of the width of the image on the screen
        ...
        [HttpPost]
        public ActionResult _UploadFile(IEnumerable<HttpPostedFileBase> files)
        {
